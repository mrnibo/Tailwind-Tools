...
const BoxShadow: React.FC = () => {
  ...
  return (
    <div className="p-4 flex items-start space-x-8 container">
      <div className="flex-1">
        <div
          className="p-4 border rounded-xl w-[40rem] h-[20rem] flex items-center justify-center bg-white dark:bg-black dark:border-gray-800"
          style={{ boxShadow: vanillaBoxShadow }}
        >
          Box with shadow
        </div>
        <div className="mt-4 space-y-2">
          <Snippet className="w-[40rem]" color="primary" symbol="Vanilla CSS:">
            {vanillaBoxShadow}
          </Snippet>
          <Snippet className="w-[40rem]" color="secondary" symbol="Tailwind:">
            {tailwindBoxShadow}
          </Snippet>
        </div>
      </div>
      <div className="bg-white p-6 rounded-md shadow-lg w-full dark:bg-black dark:text-gray-200 dark:shadow-[1px_0px_10px_1px_#08080891]">
        <h2 className="text-2xl font-semibold mb-4">Box Shadow Generator</h2>
